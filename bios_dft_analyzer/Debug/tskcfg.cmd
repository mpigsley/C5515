...
SECTIONS {
       ...
       /* no HWI stubs are necessary */
        ...
        .TSK_FFTProcessor$stk: block(0x20000){
            *(.TSK_FFTProcessor$stk)
        } > DARAM PAGE 0
